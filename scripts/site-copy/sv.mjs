...
export default {
  ...
  features: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: `Peer-to-peer-samtal över WebRTC, som krypterar medierna mellan de två enheterna som standard snarare än som ett tillval.`,
      },
      {
        title: `Svarsförslag`,
  ...
  limits: {
    ...
    visible: {
      title: 'Synligt för oss och för Google',
      items: [
