...
Versions 1.2.0 and earlier also saved a copy of the phrase to Google Block Store, Android's own backup, each time you signed in. If your phone had a screen lock, that copy was synced to your Google account, end-to-end encrypted. From version 1.2.1 the app no longer does this, and deletes that copy each time it starts.`,
    },
    {
...
1.2.0 及更早的版本还会在每次登录时，把助记词的一份副本存入 Android 系统自带的备份 Google Block Store。如果你的手机设置了锁屏，这份副本会以端到端加密的形式同步到你的 Google 账号。从 1.2.1 版起，应用不再这样做，并会在每次启动时删除这份副本。`,
    },
    {
      title: '6. 还有谁会拿到数据',
...
Versionen bis einschließlich 1.2.0 haben bei jeder Anmeldung außerdem eine Kopie der Phrase in Google Block Store gespeichert, dem eigenen Backup von Android. Hatte dein Telefon eine Displaysperre, wurde diese Kopie Ende-zu-Ende-verschlüsselt mit deinem Google-Konto synchronisiert. Ab Version 1.2.1 tut die App das nicht mehr und löscht diese Kopie bei jedem Start.`,
    },
    {
...
Las versiones 1.2.0 y anteriores también guardaban una copia de la frase en Google Block Store, la copia de seguridad propia de Android, cada vez que iniciabas sesión. Si tu teléfono tenía bloqueo de pantalla, esa copia se sincronizaba con tu cuenta de Google, cifrada de extremo a extremo. Desde la versión 1.2.1 la app ya no lo hace, y borra esa copia cada vez que se inicia.`,
    },
    {
...
Les versions 1.2.0 et antérieures enregistraient aussi une copie de la phrase dans Google Block Store, la sauvegarde propre à Android, à chaque connexion. Si votre téléphone avait un verrouillage d'écran, cette copie était synchronisée avec votre compte Google, chiffrée de bout en bout. Depuis la version 1.2.1, l'app ne le fait plus et supprime cette copie à chaque démarrage.`,
    },
    {
...
Le versioni 1.2.0 e precedenti salvavano anche una copia della frase in Google Block Store, il backup proprio di Android, a ogni accesso. Se il telefono aveva un blocco schermo, quella copia veniva sincronizzata con il tuo account Google, cifrata end-to-end. Dalla versione 1.2.1 l'app non lo fa più, e cancella quella copia a ogni avvio.`,
    },
    {
...
As versões 1.2.0 e anteriores também guardavam uma cópia da frase no Google Block Store, a cópia de segurança do próprio Android, sempre que iniciavas sessão. Se o telemóvel tinha bloqueio de ecrã, essa cópia era sincronizada com a tua conta Google, encriptada ponto a ponto. A partir da versão 1.2.1 a app deixou de o fazer, e apaga essa cópia sempre que arranca.`,
    },
    {
...
Версии 1.2.0 и более ранние при каждом входе также сохраняли копию фразы в Google Block Store — системную резервную копию Android. Если на телефоне была блокировка экрана, эта копия синхронизировалась с вашим аккаунтом Google со сквозным шифрованием. Начиная с версии 1.2.1 приложение так больше не делает и удаляет эту копию при каждом запуске.`,
    },
    {
...
1.2.0 ve önceki sürümler, her oturum açtığında ifadenin bir kopyasını Android'in kendi yedeği olan Google Block Store'a da kaydediyordu. Telefonunda ekran kilidi varsa bu kopya, uçtan uca şifreli olarak Google hesabınla eşitleniyordu. 1.2.1 sürümünden itibaren uygulama bunu artık yapmaz ve her açılışta bu kopyayı siler.`,
    },
    {
...
Các phiên bản 1.2.0 trở về trước còn lưu một bản sao cụm từ vào Google Block Store, bản sao lưu của chính Android, mỗi khi bạn đăng nhập. Nếu điện thoại có khoá màn hình, bản sao đó được đồng bộ lên tài khoản Google của bạn ở dạng mã hoá đầu cuối. Từ phiên bản 1.2.1, ứng dụng không làm vậy nữa và xoá bản sao đó mỗi lần khởi động.`,
    },
    {
...
バージョン 1.2.0 以前は、サインインのたびに、フレーズのコピーを Android 自身のバックアップである Google Block Store にも保存していました。スマートフォンに画面ロックが設定されていた場合、そのコピーはエンドツーエンドで暗号化されてあなたの Google アカウントに同期されていました。バージョン 1.2.1 以降、アプリはこれを行わず、起動するたびにそのコピーを削除します。`,
    },
    {
      title: '6. ほかに情報を受け取る先',
...
1.2.0 및 이전 버전은 로그인할 때마다 문구의 사본을 Android 자체 백업인 Google Block Store에도 저장했습니다. 휴대폰에 화면 잠금이 있었다면 그 사본은 종단 간 암호화된 상태로 당신의 Google 계정에 동기화되었습니다. 1.2.1 버전부터 앱은 더 이상 이렇게 하지 않으며, 시작할 때마다 그 사본을 삭제합니다.`,
    },
    {
...
1.2.0 及更早的版本還會在每次登入時，把助記詞的一份副本存入 Android 系統內建的備份 Google Block Store。如果你的手機設定了螢幕鎖定，這份副本會以端對端加密的形式同步到你的 Google 帳號。從 1.2.1 版起，應用程式不再這樣做，並會在每次啟動時刪除這份副本。`,
    },
    {
      title: '6. 還有誰會拿到資料',
...
كانت الإصدارات 1.2.0 وما قبلها تحفظ أيضًا نسخة من العبارة في Google Block Store، وهو النسخ الاحتياطي الخاص بنظام Android، في كل مرة تسجّل فيها الدخول. وإن كان لهاتفك قفل شاشة، كانت تلك النسخة تُزامَن مع حسابك في Google معمّاةً من طرف إلى طرف. ومنذ الإصدار 1.2.1 لم يعد التطبيق يفعل ذلك، ويحذف تلك النسخة في كل مرة يبدأ فيها.`,
    },
    {
...
संस्करण 1.2.0 और उससे पहले के संस्करण हर साइन इन पर वाक्यांश की एक प्रति Android के अपने बैकअप Google Block Store में भी सहेजते थे। अगर आपके फ़ोन में स्क्रीन लॉक था, तो वह प्रति एंड-टू-एंड एन्क्रिप्टेड रूप में आपके Google खाते में सिंक होती थी। संस्करण 1.2.1 से ऐप ऐसा नहीं करता, और हर बार शुरू होने पर उस प्रति को मिटा देता है।`,
    },
    {
...
نسخه‌های 1.2.0 و پیش از آن، هر بار که وارد می‌شدید، یک نسخه از عبارت را در Google Block Store، پشتیبان خود Android، هم ذخیره می‌کردند. اگر گوشی شما قفل صفحه داشت، آن نسخه با رمزگذاری سرتاسری با حساب Google شما همگام می‌شد. از نسخهٔ 1.2.1 برنامه دیگر این کار را نمی‌کند و هر بار که اجرا می‌شود آن نسخه را پاک می‌کند.`,
    },
    {
...
גרסאות 1.2.0 ומוקדמות יותר שמרו בכל התחברות גם עותק של הביטוי ב-Google Block Store, הגיבוי של Android עצמו. אם בטלפון הייתה נעילת מסך, העותק סונכרן לחשבון Google שלכם כשהוא מוצפן מקצה לקצה. מגרסה 1.2.1 האפליקציה כבר לא עושה זאת, והיא מוחקת את העותק הזה בכל הפעלה.`,
    },
    {
...
ورژن 1.2.0 اور اس سے پہلے کے ورژن ہر سائن اِن پر فقرے کی ایک نقل Android کے اپنے بیک اپ Google Block Store میں بھی محفوظ کرتے تھے۔ اگر آپ کے فون میں اسکرین لاک تھا تو وہ نقل اینڈ ٹو اینڈ انکرپٹڈ شکل میں آپ کے Google اکاؤنٹ سے سنک ہوتی تھی۔ ورژن 1.2.1 سے ایپ ایسا نہیں کرتی، اور ہر بار شروع ہونے پر وہ نقل حذف کر دیتی ہے۔`,
    },
    {
...
Wersje 1.2.0 i wcześniejsze przy każdym logowaniu zapisywały też kopię frazy w Google Block Store, kopii zapasowej samego Androida. Jeśli telefon miał blokadę ekranu, ta kopia była synchronizowana z Twoim kontem Google, zaszyfrowana end-to-end. Od wersji 1.2.1 aplikacja już tego nie robi i usuwa tę kopię przy każdym uruchomieniu.`,
    },
    {
...
Версії 1.2.0 і раніші під час кожного входу також зберігали копію фрази в Google Block Store — системній резервній копії Android. Якщо на телефоні було блокування екрана, ця копія синхронізувалася з вашим обліковим записом Google з наскрізним шифруванням. Починаючи з версії 1.2.1 застосунок цього більше не робить і видаляє цю копію під час кожного запуску.`,
    },
    {
...
Versi 1.2.0 dan sebelumnya juga menyimpan salinan frasa ke Google Block Store, cadangan bawaan Android, setiap kali Anda masuk. Jika ponsel Anda memiliki kunci layar, salinan itu disinkronkan ke akun Google Anda dalam keadaan terenkripsi end-to-end. Sejak versi 1.2.1 aplikasi tidak lagi melakukannya, dan menghapus salinan itu setiap kali dijalankan.`,
    },
    {
...
সংস্করণ 1.2.0 ও তার আগের সংস্করণগুলো প্রতিবার সাইন ইন করার সময় বাক্যাংশের একটি কপি Android-এর নিজস্ব ব্যাকআপ Google Block Store-এও সংরক্ষণ করত। আপনার ফোনে স্ক্রিন লক থাকলে সেই কপি এন্ড-টু-এন্ড এনক্রিপ্টেড অবস্থায় আপনার Google অ্যাকাউন্টে সিঙ্ক হতো। সংস্করণ 1.2.1 থেকে অ্যাপটি আর তা করে না, এবং প্রতিবার চালু হওয়ার সময় সেই কপি মুছে ফেলে।`,
    },
    {
...
เวอร์ชัน 1.2.0 และก่อนหน้านั้นยังบันทึกสำเนาของวลีลงใน Google Block Store ซึ่งเป็นข้อมูลสำรองของ Android เองทุกครั้งที่คุณลงชื่อเข้าใช้ หากโทรศัพท์ของคุณมีการล็อกหน้าจอ สำเนานั้นจะซิงค์ไปยังบัญชี Google ของคุณแบบเข้ารหัสตั้งแต่ต้นทางถึงปลายทาง ตั้งแต่เวอร์ชัน 1.2.1 แอปไม่ทำเช่นนั้นอีกแล้ว และจะลบสำเนานั้นทุกครั้งที่เริ่มทำงาน`,
    },
    {
...
Ang mga bersyon 1.2.0 at mas luma ay nagse-save din ng kopya ng phrase sa Google Block Store, ang sariling backup ng Android, tuwing nagsa-sign in ka. Kung may screen lock ang iyong telepono, sini-sync ang kopyang iyon sa iyong Google account nang end-to-end encrypted. Mula sa bersyon 1.2.1, hindi na ito ginagawa ng app, at binubura nito ang kopyang iyon tuwing magsisimula ito.`,
    },
    {
...
Versi 1.2.0 dan sebelumnya turut menyimpan salinan frasa dalam Google Block Store, sandaran Android sendiri, setiap kali anda log masuk. Jika telefon anda mempunyai kunci skrin, salinan itu disegerakkan ke akaun Google anda dalam keadaan disulitkan hujung ke hujung. Mulai versi 1.2.1 aplikasi tidak lagi berbuat demikian, dan memadamkan salinan itu setiap kali ia bermula.`,
    },
    {
      title: '6. Siapa lagi yang menerima data',
...
ဗားရှင်း 1.2.0 နှင့် ယခင်ဗားရှင်းများသည် သင် sign in ဝင်တိုင်း phrase ၏ မိတ္တူကို Android ၏ ကိုယ်ပိုင် backup ဖြစ်သော Google Block Store ထဲသို့လည်း သိမ်းဆည်းခဲ့သည်။ သင့်ဖုန်း၌ screen lock ရှိခဲ့ပါက ထိုမိတ္တူကို end-to-end encrypted အဖြစ် သင့် Google အကောင့်သို့ sync လုပ်ခဲ့သည်။ ဗားရှင်း 1.2.1 မှစ၍ app သည် ထိုသို့ မလုပ်တော့ဘဲ စတင်ဖွင့်တိုင်း ထိုမိတ္တူကို ဖျက်ပစ်သည်။`,
    },
    {
...
កំណែ 1.2.0 និងមុននោះ ក៏បានរក្សាទុកច្បាប់ចម្លងនៃឃ្លានៅក្នុង Google Block Store ដែលជាការបម្រុងទុករបស់ Android ផ្ទាល់ រាល់ពេលអ្នកចូលគណនីដែរ។ បើទូរស័ព្ទរបស់អ្នកមានការចាក់សោអេក្រង់ ច្បាប់ចម្លងនោះត្រូវបានធ្វើសមកាលកម្មទៅគណនី Google របស់អ្នក ក្នុងទម្រង់អ៊ិនគ្រីបពីចុងដល់ចុង។ ចាប់ពីកំណែ 1.2.1 កម្មវិធីលែងធ្វើដូច្នេះទៀតហើយ ហើយលុបច្បាប់ចម្លងនោះរាល់ពេលវាចាប់ផ្ដើម។`,
    },
    {
...
ເວີຊັນ 1.2.0 ແລະ ກ່ອນໜ້ານັ້ນ ຍັງບັນທຶກສຳເນົາຂອງວະລີໄວ້ໃນ Google Block Store ເຊິ່ງເປັນການສຳຮອງຂໍ້ມູນຂອງ Android ເອງ ທຸກຄັ້ງທີ່ທ່ານເຂົ້າສູ່ລະບົບ. ຖ້າໂທລະສັບຂອງທ່ານມີການລັອກໜ້າຈໍ, ສຳເນົານັ້ນຈະຊິງໄປຫາບັນຊີ Google ຂອງທ່ານແບບເຂົ້າລະຫັດແຕ່ຕົ້ນທາງຫາປາຍທາງ. ຕັ້ງແຕ່ເວີຊັນ 1.2.1 ແອັບບໍ່ເຮັດແບບນັ້ນອີກແລ້ວ ແລະ ຈະລຶບສຳເນົານັ້ນທຸກຄັ້ງທີ່ເລີ່ມເຮັດວຽກ.`,
    },
    {
...
பதிப்பு 1.2.0 மற்றும் அதற்கு முந்தைய பதிப்புகள், நீங்கள் உள்நுழையும் ஒவ்வொரு முறையும் சொற்றொடரின் ஒரு நகலை Android-இன் சொந்த காப்புப்பிரதியான Google Block Store-இலும் சேமித்தன. உங்கள் தொலைபேசியில் திரைப் பூட்டு இருந்திருந்தால், அந்த நகல் முழுமையாக மறைகுறியாக்கப்பட்ட நிலையில் உங்கள் Google கணக்குடன் ஒத்திசைக்கப்பட்டது. பதிப்பு 1.2.1 முதல் செயலி இதைச் செய்வதில்லை, ஒவ்வொரு முறை தொடங்கும்போதும் அந்த நகலை நீக்குகிறது.`,
    },
    {
...
వెర్షన్ 1.2.0 మరియు అంతకు ముందు వెర్షన్‌లు మీరు సైన్ ఇన్ చేసిన ప్రతిసారీ పదబంధం యొక్క ఒక కాపీని Android సొంత బ్యాకప్ అయిన Google Block Storeలో కూడా సేవ్ చేసేవి. మీ ఫోన్‌కు స్క్రీన్ లాక్ ఉంటే, ఆ కాపీ ఎండ్-టు-ఎండ్ ఎన్‌క్రిప్ట్ అయి మీ Google ఖాతాకు సింక్ అయ్యేది. వెర్షన్ 1.2.1 నుండి యాప్ ఇలా చేయదు, ప్రారంభమైన ప్రతిసారీ ఆ కాపీని తొలగిస్తుంది.`,
    },
    {
...
आवृत्ती 1.2.0 आणि त्यापूर्वीच्या आवृत्त्या प्रत्येक साइन इनवेळी वाक्यांशाची एक प्रत Android च्या स्वतःच्या बॅकअप Google Block Store मध्येही जतन करत असत. तुमच्या फोनला स्क्रीन लॉक असल्यास ती प्रत एंड-टू-एंड एन्क्रिप्टेड स्वरूपात तुमच्या Google खात्याशी सिंक होत असे. आवृत्ती 1.2.1 पासून अ‍ॅप असे करत नाही, आणि प्रत्येक वेळी सुरू होताना ती प्रत हटवतो.`,
    },
    {
...
ਵਰਜਨ 1.2.0 ਅਤੇ ਇਸ ਤੋਂ ਪਹਿਲਾਂ ਦੇ ਵਰਜਨ ਹਰ ਸਾਈਨ ਇਨ ਉੱਤੇ ਵਾਕੰਸ਼ ਦੀ ਇੱਕ ਕਾਪੀ Android ਦੇ ਆਪਣੇ ਬੈਕਅੱਪ Google Block Store ਵਿੱਚ ਵੀ ਸੰਭਾਲਦੇ ਸਨ। ਜੇ ਤੁਹਾਡੇ ਫ਼ੋਨ ਵਿੱਚ ਸਕ੍ਰੀਨ ਲੌਕ ਸੀ, ਤਾਂ ਉਹ ਕਾਪੀ ਐਂਡ-ਟੂ-ਐਂਡ ਇਨਕ੍ਰਿਪਟਡ ਰੂਪ ਵਿੱਚ ਤੁਹਾਡੇ Google ਖਾਤੇ ਨਾਲ ਸਿੰਕ ਹੁੰਦੀ ਸੀ। ਵਰਜਨ 1.2.1 ਤੋਂ ਐਪ ਅਜਿਹਾ ਨਹੀਂ ਕਰਦੀ, ਅਤੇ ਹਰ ਵਾਰ ਸ਼ੁਰੂ ਹੋਣ ਉੱਤੇ ਉਹ ਕਾਪੀ ਮਿਟਾ ਦਿੰਦੀ ਹੈ।`,
    },
    {
...
संस्करण 1.2.0 र त्यसभन्दा अघिका संस्करणहरूले हरेक पटक साइन इन गर्दा वाक्यांशको एउटा प्रतिलिपि Android को आफ्नै ब्याकअप Google Block Store मा पनि सुरक्षित गर्थे। तपाईंको फोनमा स्क्रिन लक भएमा त्यो प्रतिलिपि एन्ड-टु-एन्ड इन्क्रिप्टेड रूपमा तपाईंको Google खातासँग सिंक हुन्थ्यो। संस्करण 1.2.1 देखि एपले यसो गर्दैन, र हरेक पटक सुरु हुँदा त्यो प्रतिलिपि मेटाउँछ।`,
    },
    {
...
1.2.0 අනුවාදය සහ ඊට පෙර අනුවාද, ඔබ පුරනය වන සෑම වරකම වාක්‍ය ඛණ්ඩයේ පිටපතක් Android හි උපස්ථය වන Google Block Store වෙත ද සුරැකීය. ඔබේ දුරකථනයට තිර අගුලක් තිබුණේ නම්, එම පිටපත අන්තයේ සිට අන්තය දක්වා සංකේතනය කර ඔබේ Google ගිණුමට සමමුහුර්ත විය. 1.2.1 අනුවාදයේ සිට යෙදුම එසේ නොකරන අතර, එය ආරම්භ වන සෑම වරකම එම පිටපත මකා දමයි.`,
    },
    {
...
Matoleo ya 1.2.0 na ya awali pia yalihifadhi nakala ya kifungu kwenye Google Block Store, hifadhi rudufu ya Android yenyewe, kila ulipoingia. Ikiwa simu yako ilikuwa na kufuli ya skrini, nakala hiyo ilisawazishwa na akaunti yako ya Google ikiwa imesimbwa kutoka mwanzo hadi mwisho. Kuanzia toleo la 1.2.1 programu haifanyi hivyo tena, na hufuta nakala hiyo kila inapoanza.`,
    },
    {
...
Sigar 1.2.0 da waɗanda suka gabace ta sun kuma adana kwafin jimlar a Google Block Store, ajiyar Android ta kanta, duk lokacin da ka shiga. Idan wayarka tana da makullin allo, an daidaita wannan kwafin da asusunka na Google a ɓoye daga farko zuwa ƙarshe. Daga sigar 1.2.1 manhajar ba ta ƙara yin haka, kuma tana goge wannan kwafin duk lokacin da ta fara aiki.`,
    },
    {
...
ስሪት 1.2.0 እና ከዚያ በፊት የነበሩት ስሪቶች በገቡ ቁጥር የሐረጉን ቅጂ የ Android የራሱ ምትኬ በሆነው Google Block Store ውስጥም ያስቀምጡ ነበር። ስልክዎ የማያ ገጽ መቆለፊያ ካለው፣ ያ ቅጂ ከጫፍ እስከ ጫፍ ተመስጥሮ ከ Google መለያዎ ጋር ይመሳሰል ነበር። ከስሪት 1.2.1 ጀምሮ መተግበሪያው ይህን አያደርግም፣ በጀመረ ቁጥርም ያንን ቅጂ ይሰርዛል።`,
    },
    {
...
Versies 1.2.0 en eerder bewaarden bij elke aanmelding ook een kopie van de zin in Google Block Store, de eigen back-up van Android. Had je telefoon een schermvergrendeling, dan werd die kopie end-to-end versleuteld met je Google-account gesynchroniseerd. Vanaf versie 1.2.1 doet de app dat niet meer, en verwijdert hij die kopie bij elke start.`,
    },
    {
...
Οι εκδόσεις 1.2.0 και παλαιότερες αποθήκευαν επίσης, σε κάθε σύνδεση, ένα αντίγραφο της φράσης στο Google Block Store, το αντίγραφο ασφαλείας του ίδιου του Android. Αν το τηλέφωνό σας είχε κλείδωμα οθόνης, αυτό το αντίγραφο συγχρονιζόταν με τον λογαριασμό σας Google κρυπτογραφημένο από άκρο σε άκρο. Από την έκδοση 1.2.1 η εφαρμογή δεν το κάνει πια, και διαγράφει αυτό το αντίγραφο σε κάθε εκκίνηση.`,
    },
    {
...
Version 1.2.0 och tidigare sparade också en kopia av frasen i Google Block Store, Androids egen säkerhetskopia, varje gång du loggade in. Om telefonen hade ett skärmlås synkades kopian till ditt Google-konto, end-to-end-krypterad. Från version 1.2.1 gör appen inte längre det, och raderar den kopian varje gång den startar.`,
    },
    {
...
Version 1.2.0 og tidligere gemte også en kopi af sætningen i Google Block Store, Androids egen sikkerhedskopi, hver gang du loggede ind. Hvis telefonen havde skærmlås, blev kopien synkroniseret til din Google-konto, end-to-end-krypteret. Fra version 1.2.1 gør appen det ikke længere, og den sletter kopien, hver gang den starter.`,
    },
    {
...
Versjon 1.2.0 og tidligere lagret også en kopi av frasen i Google Block Store, Androids egen sikkerhetskopi, hver gang du logget inn. Hvis telefonen hadde skjermlås, ble kopien synkronisert til Google-kontoen din, ende-til-ende-kryptert. Fra versjon 1.2.1 gjør appen ikke dette lenger, og den sletter kopien hver gang den starter.`,
    },
    {
...
Verze 1.2.0 a starší při každém přihlášení ukládaly kopii fráze také do Google Block Store, vlastní zálohy Androidu. Pokud měl telefon zámek obrazovky, tato kopie se synchronizovala s vaším účtem Google, šifrovaná end-to-end. Od verze 1.2.1 to aplikace už nedělá a tuto kopii při každém spuštění smaže.`,
    },
    {
...
Versiunile 1.2.0 și anterioare salvau, la fiecare autentificare, și o copie a frazei în Google Block Store, backupul propriu al Android. Dacă telefonul avea blocare a ecranului, acea copie era sincronizată cu contul tău Google, criptată end-to-end. Începând cu versiunea 1.2.1, aplicația nu mai face asta și șterge acea copie la fiecare pornire.`,
    },
    {
...
Az 1.2.0-s és korábbi verziók minden bejelentkezéskor a mondat egy másolatát is elmentették a Google Block Store-ba, az Android saját biztonsági mentésébe. Ha a telefonon volt képernyőzár, ez a másolat végpontok között titkosítva szinkronizálódott a Google-fiókodba. Az 1.2.1-es verziótól az alkalmazás ezt már nem teszi, és minden indításkor törli ezt a másolatot.`,
    },
    {
...
1.2.0 және одан бұрынғы нұсқалар әр кірген сайын фразаның көшірмесін Android-тің өз сақтық көшірмесі — Google Block Store-ға да сақтайтын. Телефоныңызда экран құлпы болса, бұл көшірме ұштан-ұшқа шифрланып, Google аккаунтыңызбен синхрондалатын. 1.2.1 нұсқасынан бастап қолданба бұлай істемейді және әр іске қосылған сайын сол көшірмені жояды.`,
    },
    {
...
1.2.0 va undan oldingi versiyalar har safar kirganingizda iboraning nusxasini Android'ning o'z zaxira nusxasi bo'lgan Google Block Store'ga ham saqlagan. Agar telefoningizda ekran qulfi bo'lsa, o'sha nusxa uchdan-uchgacha shifrlangan holda Google hisobingiz bilan sinxronlangan. 1.2.1 versiyasidan boshlab ilova bunday qilmaydi va har safar ishga tushganda o'sha nusxani o'chiradi.`,
    },
    {
...
1.2.0 და უფრო ადრეული ვერსიები ყოველი შესვლისას ფრაზის ასლს Android-ის საკუთარ სარეზერვო ასლშიც, Google Block Store-ში, ინახავდნენ. თუ თქვენს ტელეფონს ეკრანის დაბლოკვა ჰქონდა, ეს ასლი ბოლომდე დაშიფრული სინქრონიზდებოდა თქვენს Google ანგარიშთან. 1.2.1 ვერსიიდან აპი ამას აღარ აკეთებს და ყოველი გაშვებისას შლის ამ ასლს.`,
    },
    {
...
1.2.0 և ավելի վաղ տարբերակները յուրաքանչյուր մուտքի ժամանակ արտահայտության պատճենը պահում էին նաև Google Block Store-ում՝ Android-ի սեփական պահուստային պատճենում։ Եթե ձեր հեռախոսն ուներ էկրանի կողպում, այդ պատճենը ծայրից ծայր գաղտնագրված համաժամացվում էր ձեր Google հաշվի հետ։ 1.2.1 տարբերակից սկսած՝ հավելվածն այլևս դա չի անում և ամեն գործարկման ժամանակ ջնջում է այդ պատճենը։`,
    },
    {
...
Версіі 1.2.0 і больш раннія пры кожным уваходзе таксама захоўвалі копію фразы ў Google Block Store — сістэмнай рэзервовай копіі Android. Калі на тэлефоне была блакіроўка экрана, гэтая копія сінхранізавалася з вашым уліковым запісам Google са скразным шыфраваннем. Пачынаючы з версіі 1.2.1 праграма гэтага больш не робіць і выдаляе гэтую копію пры кожным запуску.`,
    },
    {
...
ስሪት 1.2.0 ከምኡ'ውን ቅድሚኡ ዝነበሩ ስሪታት፡ ኣብ ዝኣተኻሉ ግዜ ኩሉ ናይቲ ሓረግ ቅዳሕ ኣብ Google Block Store፡ ናይ Android ባዕሉ ባክኣፕ፡ የቐምጡ ነይሮም። ስልክኻ መዓጸዊ ስክሪን እንተነይርዎ፡ እቲ ቅዳሕ ካብ ጫፍ ክሳብ ጫፍ ተመስጢሩ ምስ ናይ Google ሕሳብካ ይሰማማዕ ነይሩ። ካብ ስሪት 1.2.1 ጀሚሩ እቲ ኣፕ ከምኡ ኣይገብርን፡ ኣብ ዝጅምረሉ ግዜ ኩሉ ድማ ነቲ ቅዳሕ ይድምስሶ።`,
    },
    {
...
པར་གཞི 1.2.0 དང་དེའི་སྔོན་གྱི་པར་གཞི་རྣམས་ཀྱིས་ཁྱེད་ནང་འཛུལ་བྱེད་ཐེངས་རེ་རེར་ཚིག་སྡེབ་ཀྱི་འདྲ་བཤུས་ཤིག་ Android རང་གི་གྲབས་ཉར་ Google Block Store ནང་དུའང་ཉར་གྱི་ཡོད། ཁྱེད་ཀྱི་ཁ་པར་ལ་བརྙན་ཡོལ་ཟྭ་ཡོད་ན། འདྲ་བཤུས་དེ་མཐའ་ནས་མཐའ་བར་གསང་སྦྱོར་བྱས་ནས་ཁྱེད་ཀྱི་ Google ཐོ་ཁོངས་དང་མཉམ་སྒྲིག་བྱེད་ཀྱི་ཡོད། པར་གཞི 1.2.1 ནས་བཟུང་མཉེན་ཆས་ཀྱིས་དེ་ལྟར་མི་བྱེད་ལ། འགོ་འཛུགས་ཐེངས་རེ་རེར་འདྲ་བཤུས་དེ་བསུབ་ཀྱི་ཡོད།`,
    },
    {
...
1.2.0 болон түүнээс өмнөх хувилбарууд таныг нэвтрэх бүрт хэллэгийн хуулбарыг Android-ийн өөрийн нөөц болох Google Block Store-д мөн хадгалдаг байсан. Хэрэв таны утсанд дэлгэцийн түгжээ байсан бол тэр хуулбар төгсгөлөөс төгсгөл хүртэл шифрлэгдсэн байдлаар таны Google бүртгэлтэй синк хийгддэг байв. 1.2.1 хувилбараас эхлэн апп ингэхээ больсон бөгөөд эхлэх бүртээ тэр хуулбарыг устгадаг.`,
    },
    {
