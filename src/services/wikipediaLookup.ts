 ...
 *
 * The old service was hardcoded to `en`, which for a fifteen-language app
 * meant most users got an English article about a name they had written in
 * their own language. Both Chinese variants map to `zh`: Wikipedia serves one
 * `zh` wiki and converts script per reader.
 */
