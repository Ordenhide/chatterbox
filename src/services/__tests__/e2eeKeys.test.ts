...
// keyBackup only deletes what versions up to 1.2.0 left in the platform
// backup; it reaches native code this suite has no business booting.
jest.mock('../keyBackup', () => ({
  clearRecoveryPhrase: jest.fn(async () => undefined),
}));
